\begin{tikzpicture}
  \begin{groupplot}[group style={group size=2 by 2, % 3 columns 2 rows
    ...
    %\addplot[black,thick,mark=*,mark repeat=2] table[x=Points:0,y=Piola_Stress:0] {csvFiles/femFine_bottom1.csv};
    ...
    %\addplot[black,thick,mark=*,mark repeat=2] table[x=Points:0,y=Piola_Stress:0] {csvFiles/femFine_bottom2.csv};
    ...
    %\addplot[black,thick,mark=*,mark repeat=2] table[x=Points:0,y=Equivalent_Plastic_Strain] {csvFiles/femFine_bottom1.csv};
    ...
    %\addplot[black,thick,mark=*,mark repeat=2] table[x=Points:0,y=Equivalent_Plastic_Strain] {csvFiles/femFine_bottom2.csv};
