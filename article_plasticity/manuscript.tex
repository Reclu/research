...
\begin{frontmatter}
  ...
  \begin{abstract}
    ...
    The genericity provided for dealing with rate-indepedant or rate-dependant plasticity, as well as the possibility to easily extend the DGMPM to thermomechanical problems, make this class of integrators appealing.
    % This class of integrators provides a generic framework for dealing with hyperelastic-plastic or hyperelastic-viscoplastic solids, and should facilitate the extension of the method to strongly thermomechanically coupled problems.
    The total Lagrangian formulation of the resulting approach is then illustrated on numerical examples for which comparisons are shown with the finite element and the material point methods, as well as exact solution in the linearized geometrical limit.
  \end{abstract}
