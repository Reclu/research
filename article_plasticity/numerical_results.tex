...
%\review{Then, a finite element (or DGMPM) solution computed on a finer mesh made of $300$ cells is used as a reference one. The solution is much more complicated and involves much more interaction of plastic and elastic waves. Maybe it could be a good idea to restrict the time interval.}
% \begin{figure}[ht]
%   \centering
