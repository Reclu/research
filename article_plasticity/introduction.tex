...
%An important class of models is that of dissipative solid behaviors depending on the loading history undergone, which is implicated in high-speed forming techniques or crash-proof design for instance.
