...
\pgfdeclareimage[width = 0.17\paperwidth]{logocn}{cover/TemplateFiles/logocn-rvb} % Logo ECN-rvb
\pgfdeclareimage[width = 0.30\paperwidth]{logospi}{cover/TemplateFiles/logospi} % Logo UBL-Spi
\pgfdeclareimage[width = \paperwidth]{FondOne}{cover/TemplateFiles/FondSpiBlue} % Backgroud UBL-Spi
\pgfdeclareimage[width = 0.9\paperwidth]{FondTop}{cover/TemplateFiles/TriangleBlueTop} % Blue Triangle on top
\pgfdeclareimage[width = 0.9\paperwidth]{FondBottom}{cover/TemplateFiles/TriangleBlueBottom} % Blue Triangle on bottom
\pgfdeclareimage[width = 0.9\paperwidth]{Line}{cover/TemplateFiles/LineBlue} % Blue Line
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=north west] at ([yshift=-30.mm,xshift=-36.5mm]spilogo.south west) (fondone) {\parbox[t]{\paperwidth}{\pgfuseimage{FondOne}}};
  % 
  \node[anchor=south west]  at ([yshift=-33mm,xshift=0mm]spilogo.south west) (these){\parbox[t]{.5\paperwidth} {\huge \scshape \fontfamily{phv}\selectfont Thèse de doctorat de}};	
  % 
  \node[anchor=south west] at ([yshift=-33mm,xshift=0mm]these.south west) (ecn) {\parbox[t]{.5\paperwidth}{\Large \scshape \fontfamily{phv}\selectfont L'école centrale de nantes }};	
  % 
  \node[anchor=south west] at ([yshift=-6mm,xshift=0mm]ecn.south west) (ubl) {\parbox[t]{.5\paperwidth}{
      {\Large \fontfamily{phv}\selectfont \scshape ComueUniversitéBretagneLoire }}};
  %
  \node[anchor=south west]  at ([yshift=-13mm,xshift=0mm]ubl.south west) (ed)  {\parbox[t]{.5\paperwidth}{\large \scshape \fontfamily{phv}\selectfont Ecole Doctorale N$^{o}$ 602}};
  %
