...
\subsection{Space convergence analysis of the one-dimensonal scheme}
...
Finally, it is worth noticing that only reguarly-spaced material points have been considered in the above convergence analysis. An additional solution to achieve high-order accuracy can be derived for the following theorem for the one-dimensonal scalar linear advection equation with $a>0$:
