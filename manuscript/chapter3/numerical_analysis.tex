...
\item[(v)] particles are placed symmetrically with respect to cells centers but not regularly spaced in the mesh. Material points in the left half of cells are shifted of $u_1=-\Delta X/10$ while those of the right half are shifted of $u_2=\Delta X/10$.
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
%MP = [4,8,16,32,64,128] ; ppc=[2,3,4,8] ; citer \cite[Ch.2]{Wang} (dire que c'est un problème de Picard) pour solution analytique
...
Configurations involving more particles in the computational grid cells are then studied numerically
