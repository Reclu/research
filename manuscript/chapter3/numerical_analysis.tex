...
\end{align}
which will be written for simplicity: $f^{*,(i)}=\sum_J \bar{Q}_J^n \frac{c_n N_p}{2\Delta X \Delta Y}\( \phi^{(i)} +\phi^{(i),T} \)$ where $\phi^{(i)}$ and $\phi^{(i),T}$ stand for normal and transverse fluxes contribution at edge $(i)$.
...
\begin{equation}
  ...
  \hat{f}_i^{*} = \sum_j \int_{(j)}S_i(X,Y) f^{*,(j)}  N_j dY =
  \left\lbrace
  \begin{aligned}
    & N_j \frac{\Delta Y}{2} f^{*,(j)} \quad \text{if (j) is vertical}\\
    & N_j \frac{\Delta X}{2} f^{*,(j)} \quad \text{if (j) is horizontal}
  \end{aligned}
  \right.
\end{equation}
where $N_j$ is the outward normal vector to the edge $(j)$. Hence, the nodal interface fluxes in cell $C$ are:
\begin{subequations}
  \begin{alignat}{3}
    &\hat{f}_1^{*}=-&\frac{\Delta X}{2}f^{*,(1)} -\frac{\Delta Y}{2}f^{*,(4)}=-&\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} \( \phi^{(1)} + \phi^{(1),T} \) + a\frac{\Delta t}{\Delta X} \( \phi^{(4)} + \phi^{(4),T} \) \right\rbrace \\
    &\hat{f}_2^{*}=-&\frac{\Delta X}{2}f^{*,(1)} +\frac{\Delta Y}{2}f^{*,(2)}= -&\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} \( \phi^{(1)} + \phi^{(1),T} \) - a\frac{\Delta t}{\Delta X} \( \phi^{(2)} + \phi^{(2),T} \) \right\rbrace\\
    &\hat{f}_3^{*}= &\frac{\Delta X}{2}f^{*,(3)} +\frac{\Delta Y}{2}f^{*,(2)}= &\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} \( \phi^{(3)} + \phi^{(3),T} \) + a\frac{\Delta t}{\Delta X} \( \phi^{(2)} + \phi^{(2),T} \) \right\rbrace\\
    &\hat{f}_4^{*}= &\frac{\Delta X}{2}f^{*,(3)} -\frac{\Delta Y}{2}f^{*,(4)}= &\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} \( \phi^{(3)} + \phi^{(3),T} \) - a\frac{\Delta t}{\Delta X} \( \phi^{(4)} + \phi^{(4),T} \) \right\rbrace
  \end{alignat}
\end{subequations}
Or, by using the normal vector to edge:
\begin{subequations}
  \begin{alignat}{3}
    &\hat{f}_1^{*}=-&\frac{\Delta X}{2}f^{*,(1)} -\frac{\Delta Y}{2}f^{*,(4)}=&\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} N^1_Y\( \phi^{(1)} + \phi^{(1),T} \) + a\frac{\Delta t}{\Delta X} N^4_X\( \phi^{(4)} + \phi^{(4),T} \) \right\rbrace \\
    &\hat{f}_2^{*}=-&\frac{\Delta X}{2}f^{*,(1)} +\frac{\Delta Y}{2}f^{*,(2)}= &\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} N^1_Y\( \phi^{(1)} + \phi^{(1),T} \) + a\frac{\Delta t}{\Delta X} N^2_X\( \phi^{(2)} + \phi^{(2),T} \) \right\rbrace\\
    &\hat{f}_3^{*}= &\frac{\Delta X}{2}f^{*,(3)} +\frac{\Delta Y}{2}f^{*,(2)}= &\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} N^3_Y\( \phi^{(3)} + \phi^{(3),T} \) + a\frac{\Delta t}{\Delta X} N^2_X\( \phi^{(2)} + \phi^{(2),T} \) \right\rbrace\\
    &\hat{f}_4^{*}= &\frac{\Delta X}{2}f^{*,(3)} -\frac{\Delta Y}{2}f^{*,(4)}= &\sum_J \bar{Q}_J^n m_J \frac{N_p}{4}\left\lbrace b\frac{\Delta t}{\Delta Y} N^3_Y\( \phi^{(3)} + \phi^{(3),T} \) + a\frac{\Delta t}{\Delta X} N^4_X\( \phi^{(4)} + \phi^{(4),T} \) \right\rbrace
  \end{alignat}
\end{subequations}
