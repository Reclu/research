...
\end{equation}
\thomas{As a first development step of the method, only the total Lagrangian formulation is considered in order to eliminate the grid crossing instability.}
