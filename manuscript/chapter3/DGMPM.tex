...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \fill[black] (-0.2,-0.2) circle (0.1) node [below left] {$G_c$};
    \fill[black] (0.2,-0.2) circle (0.1) node [below right] {$G_B$};
    \fill[black] (-0.2,0.2) circle (0.1) node [above left] {$G_L$};
    \fill[black] (0.2,0.2) circle (0.1) node [above right] {$N$};    
    \cross{0.3}{1.5};\cross{1.}{0.75};\cross{2.}{0.5};\cross{1.}{2.};
    \cross{2.5}{1.75};
    \draw (4.0,0.5) rectangle (7.5,1.5);
    \fill[black] (4.3,0.8) circle (0.1) node [right] {\: \text{Mesh nodes}};    
    \cross{4.3}{1.2};
