\begin{tikzpicture}[scale=1.5]
  ...
  \draw[->, very thick,Blue] (2.875,3.75) -- (2.875,4.25) node [above right] {$B^+A^+_{L/C}$}; % Top
  \draw[->, very thick,Blue] (3.75,3.125) -- (4.25,3.125) node [right] {$B^+A^+_{B/C}$}; % Right
  \draw[<-, very thick,Blue] (3.125,2.25) -- (3.125,1.75) node [below right] {$B^+A^+_{BL/B}$}; % Bottom
  ...
  \draw[<->, very thick,Red] (2.875,1.75) -- (2.875,2.25) node [above] {$f^{(1)}$}; % Bottom
  \draw[<->, very thick,Red] (1.75,3.125) -- (2.25,3.125) node [right] {$f^{(4)}$}; % Left
  %% Edges numbers
