\begin{tikzpicture}[scale=1.2]
  ...
  \draw[->, very thick,Blue] (2.875,3.75) -- (2.875,4.25);
  \node[above,Blue] at (2.5,4.25) {$B^+A^+_{L/C}$}; % Top
  \draw[->, very thick,Blue] (3.75,3.125) -- (4.25,3.125) node [right] {$B^+A^+_{B/C}$}; % Right
  \draw[<-, very thick,Blue] (3.125,2.25) -- (3.125,1.75);
  \node[below,Blue] at (3.5,1.75) {$B^+A^+_{BL/B}$}; % Bottom
  \draw[<-, very thick,Blue] (2.25,2.875) -- (1.75,2.875) node [left] {$B^+A^+_{BL/L}$}; % Left

  %% Normal fluxes
  \draw[->, very thick,Red] (3.125,3.75) -- (3.125,4.25) ; % Top
  \node[above,Red] at (3.5,4.25) {$f^{(3)}$};
  \draw[->, very thick,Red] (3.75,2.875) -- (4.25,2.875) node [right] {$f^{(2)}$}; % Right
  \draw[<-, very thick,Red] (2.875,2.25) -- (2.875,1.75); % Bottom
  \node[below left,Red] at (3.,1.75) {$f^{(1)}$};
  \draw[<-, very thick,Red] (2.25,3.125) -- (1.75,3.125)  ; % Left
  \node[left,Red] at (1.75,3.25) {$f^{(4)}$};
  % %% Edges numbers
