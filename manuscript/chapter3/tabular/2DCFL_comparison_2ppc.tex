...
%   & & \multicolumn{2}{c}{$a/b=1$} & \multicolumn{2}{c}{$a/b=10$} & \multicolumn{2}{c}{$a/b=1$} & \multicolumn{2}{c}{$a/b=10$}\\
  ...
  \end{tikzpicture}  & \input{chapter3/pgfFigures/2dCFL_2ppcH_DCU} & \input{chapter3/pgfFigures/2dCFL_2ppcH_CTU}&\\ [3.25cm]%%% SOLUTION
  \hline
  \begin{tikzpicture}[scale=1.]
    \draw[black,thick] (-1.,-1.) rectangle (1.,1.);
    \draw[black!50,dashdotted] (-1.2,0.) -- (1.2,0.0);\draw[black!50,dashdotted] (.0,-1.2) -- (0.,1.2);
  ...
  \end{tikzpicture}  & \input{chapter3/pgfFigures/2dCFL_2ppcV_DCU} & \input{chapter3/pgfFigures/2dCFL_2ppcV_CTU}& \\ [3.25cm] %%% SOLUTION
  \hline
\end{tabular}
