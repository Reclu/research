\begin{tabular}[ht]{cccccN}
  ...
  \hline
  \hline
  1 &(--) &$X^1 \in \[X^{2c-1},X^{2c}\]$  & 1.00& 1.00&\\[8pt]
  \hline
  2 &(i)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
  ...
  % 2PPC shifted
  2& (ii)&  \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  2 & (iii)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  2 & (iv)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  2 & (v)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  2 & (vi)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  \hline
  % 3PPC 
  3 & (i)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  % 3PPC shifted
  3&  (ii)&\begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
           ...
           \end{tikzpicture} &  0.23 & 0.06 &\\[8pt]
  % 3PPC shifted left on nodes
  3 & (iii)&\begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  3 & (iv)&\begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
             \fill[black] (1./3.,0) circle (0.05);\fill[black] (0.5+1./6.,0) circle (0.05);
             \fill[black] (1,0) circle (0.05);
           \end{tikzpicture} &  0.22 & 0.17 &\\[8pt]
  % 3PPC symmetrical
  3 &(v) & \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  3& (vi)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  \hline
  % 4PPC 
  4 & (i)& \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
           ...
           \end{tikzpicture} &  0.23 & 1.00&\\[8pt]
  % 4PPC shifted
  4 &(ii) & \begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  4 & (iii)&\begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  4 & (iv)&\begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  % 4PPC symmetrical
  4 & (v)&\begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
  ...
  4 & (vi)&\begin{tikzpicture}[scale=2.5]
             \draw[thick] (0,0) -- (1.,0);
             \draw[thick] (0.5,-0.05) -- (0.5,0.05);
             \fill[white] (0,0) circle (0.05);\draw (0,0) circle (0.05);
             \fill[white] (1.,0) circle (0.05);\draw (1,0) circle (0.05);
