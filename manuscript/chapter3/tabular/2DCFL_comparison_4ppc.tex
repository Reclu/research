\begin{tabular}[ht]{M{2.5cm}M{5.cm}M{5.cm}N}
  ...
  \hline
  Particles in cells & \multicolumn{2}{c}{Critical Courant number $a\Delta t /\Delta X = f(a/b)$}  & \\[0.5cm]
   &  DCU & CTU & \\
%   & & \multicolumn{2}{c}{$a/b=1$} & \multicolumn{2}{c}{$a/b=10$} & \multicolumn{2}{c}{$a/b=1$} & \multicolumn{2}{c}{$a/b=10$}\\
  ...
  \end{tikzpicture} & \input{chapter3/pgfFigures/2dCFL_4ppcS_DCU} & \input{chapter3/pgfFigures/2dCFL_4ppcS_CTU}& \\ [3.25cm]
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  ...
  \begin{tikzpicture}[scale=1.]
    ...
    \draw[Red,mark=x] plot coordinates {(-0.5-0.25,0.5)};
    \draw[Red,mark=x] plot coordinates {(0.5-0.25,-0.5)};
  \end{tikzpicture}  & \input{chapter3/pgfFigures/2dCFL_4ppcH_DCU} &\input{chapter3/pgfFigures/2dCFL_4ppcH_CTU}& \\ [3.25cm]
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{tikzpicture}[scale=1.]
    ...
    \draw[Red,mark=x] plot coordinates {(-0.5,0.5-0.25)};
    \draw[Red,mark=x] plot coordinates {(0.5,-0.5-0.25)};
  \end{tikzpicture}& \input{chapter3/pgfFigures/2dCFL_4ppcV_DCU} &\input{chapter3/pgfFigures/2dCFL_4ppcV_CTU}& \\ [3.25cm]
