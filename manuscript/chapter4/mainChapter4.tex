...
Those simulations highlight the ability of the method to track sharp solutions and the possibility of using dedicated numerical tools to accurately deal with history-dependent constitutive models, which of particular interest for the applications aimed by the DGMPM. % limiter les ondes plastiques avec un solver ep ; 
