...
Parler des courbes en pointillés ?
...
Nevertheless, it can be seen in figure \ref{fig:pureShear}\subref{subfig:pureShear1} that the pure shear state in deviatoric plan is achieved before the stress $\sigma_{22}$ stops varying.
...
Figure \ref{fig:pureShear}\subref{subfig:pureShear2} shows on the other hand the evolution of the hydrostatic pressure with respect to the stress $\sigma_{22}$. 
...
Talk  about material parameters !
% \begin{figure}[h!]
%   \centering
