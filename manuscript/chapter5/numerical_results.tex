...
\begin{figure}[h!]
  ...
  \subcaptionbox{Loading paths in the deviatoric plane \label{subfig:CP_fast_dev}}{\input{chapter5/pgfFigures/CPfastWaves_deviator0.tex}}
...
\begin{figure}[h!]
  ...
  \subcaptionbox{Loading paths in the deviatoric plane \label{subfig:CP_slow_dev1}}{\input{chapter5/pgfFigures/CPslowWaves_deviator1.tex}}
...
\begin{figure}[h!]
  ...
  \subcaptionbox{Loading paths in the deviatoric plane  \label{subfig:CP_slow_dev2}}{\input{chapter5/pgfFigures/CPslowWaves_deviator2.tex}}
...
\begin{figure}[h!]
  ...
  \subcaptionbox{Loading paths in the deviatoric plane  \label{subfig:CP_slow_dev3}}{\input{chapter5/pgfFigures/CPslowWaves_deviator3.tex}}
...
\begin{figure}[h!]
  ...
  \subcaptionbox{Loading path in the deviatoric plane \label{subfig:fastDP_dev}}{\input{chapter5/pgfFigures/DPfastWaves_deviator0.tex}}
...
\begin{figure}[h!]
  ...
  \subcaptionbox{Loading path in the deviatoric plane \label{subfig:slowDP_dev1}}{\input{chapter5/pgfFigures/DPslowWaves_deviator1.tex}}
...
\begin{figure}[h!]
  ...
  % \subcaptionbox{Loading path in the deviatoric plane \label{subfig:slowDP_dev2}}{\input{chapter5/pgfFigures/DPslowWaves_deviator2.tex}}
...
\begin{figure}[h!]
  ...
  % \subcaptionbox{Loading path in the deviatoric plane \label{subfig:slowDP_dev3}}{\input{chapter5/pgfFigures/DPslowWaves_deviator3.tex}}
