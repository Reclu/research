...
%\addplot3+[Red,mark=star,mark repeat=20,mark size=3pt,very thick,arrows along my path] file {chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastDevPlane_frame0_Stress0.pgf};
\addplot3[Orange,very thick,arrows along my path] file {chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastDevPlane_frame0_Stress0.pgf};
\addlegendentry{loading path 1}
%\addplot3+[Blue,mark=asterisk,mark repeat=20,mark size=3pt,very thick,arrows along my path] file {chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastDevPlane_frame1_Stress0.pgf};
\addplot3[Blue,very thick,arrows along my path] file {chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastDevPlane_frame1_Stress0.pgf};
