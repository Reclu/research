...
\addplot[mesh,point meta = \thisrow{p},very thick] table[x=sigma_11,y=sigma_12] {chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastStressPlane_frame0_Stress0.pgf};% node[above right,black] {$\textbf{1}$};
