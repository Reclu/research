...
\addplot3+[Green,very thick,no markers] file {chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastDevPlane_frame4_Stress0.pgf};
\addplot3+[Duck,very thick,no markers] file {chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastDevPlane_frame5_Stress0.pgf};
\end{axis}
\end{tikzpicture}
%%% Local Variables:
%%% mode: latex
