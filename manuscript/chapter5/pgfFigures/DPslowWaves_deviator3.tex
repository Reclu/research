...
\addplot3[Red,thick,arrows along my path] file {chapter5/pgfFigures/pgf_slowWavesPlaneStrain/DPslowDevPlane_frame0_Stress3.pgf};\addlegendentry{loading path 1}
\addplot3[Blue,thick,arrows along my path] file {chapter5/pgfFigures/pgf_slowWavesPlaneStrain/DPslowDevPlane_frame1_Stress3.pgf};\addlegendentry{loading path 2}
\addplot3[Orange,thick,arrows along my path] file {chapter5/pgfFigures/pgf_slowWavesPlaneStrain/DPslowDevPlane_frame2_Stress3.pgf};\addlegendentry{loading path 3}
\addplot3[Purple,thick,arrows along my path] file {chapter5/pgfFigures/pgf_slowWavesPlaneStrain/DPslowDevPlane_frame3_Stress3.pgf};\addlegendentry{loading path 4}
