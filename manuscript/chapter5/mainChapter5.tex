...
The simple wave structure in two-dimensional solids is here studied by writting the governing equations of plane strain and plane stress problems in \textbf{a unique generic framework}.
...
%% Reprend les approches de Clifton et Ting formulées en souplesse, avec une formulation en raideur. La présente approche à l'avantage de rassembler tous les problèmes 2D dans une même formulation, générique. 

%% Généralise les travaux de Clifton et Ting aux contraintes planes et ceux de Ting and Nan \cite{Ting68} aux plane strain
