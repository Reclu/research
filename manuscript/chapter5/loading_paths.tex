...
\begin{figure}[h!]
  \centering
  \subcaptionbox{Projections of loading paths in ($\sigma_{11},\sigma_{12}$) and ($\sigma_{22},\sigma_{12}$) planes}{\input{chapter5/pgfFigures/fastWaves0.tex}}
  \subcaptionbox{Loading path in deviatoric plane}{\input{chapter5/pgfFigures/fastWaves_deviator0.tex}}
...
\begin{figure}[h!]
  \centering
  \subcaptionbox{Slice ($\sigma_{11},\sigma_{12}$) plane}{\input{chapter5/pgfFigures/slowWaves1.tex}}
  \subcaptionbox{Deviatoric plane}{\input{chapter5/pgfFigures/slowWaves_deviator1.tex}}
...
\begin{figure}[h!]
  \centering
  \subcaptionbox{Slice ($\sigma_{11},\sigma_{12}$) plane}{\input{chapter5/pgfFigures/slowWaves2.tex}}
  \subcaptionbox{Deviatoric plane}{\input{chapter5/pgfFigures/slowWaves_deviator2.tex}}
  \caption{loading paths through slow simple waves. Stresses in Pa (if required)}
  \label{fig:slow_path_plane_strains}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \subcaptionbox{Slice ($\sigma_{11},\sigma_{12}$) plane}{\input{chapter5/pgfFigures/slowWaves3.tex}}
  \subcaptionbox{Deviatoric plane}{\input{chapter5/pgfFigures/slowWaves_deviator3.tex}}
  \caption{loading paths through slow simple waves. Stresses in Pa (if required)}
  \label{fig:slow_path_plane_strains}
\end{figure}
...
% \begin{figure}[h!]
%   \centering
%   \subcaptionbox{Slice ($\sigma_{11},\sigma_{12}$) plane}{\input{chapter5/pgfFigures/fastWaves2.tex}}
%   \subcaptionbox{Deviatoric plane}{\input{chapter5/pgfFigures/fastWaves_deviator2.tex}}
%   \caption{loading paths through fast simple waves. Stresses in Pa (if required)}
%   \label{fig:fast_path_plane_strains}
% \end{figure}

% \begin{figure}[h!]
%   \centering
%   \subcaptionbox{Slice ($\sigma_{11},\sigma_{12}$) plane}{\input{chapter5/pgfFigures/fastWaves3.tex}}
%   \subcaptionbox{Deviatoric plane}{\input{chapter5/pgfFigures/fastWaves_deviator3.tex}}
%   \caption{loading paths through fast simple waves. Stresses in Pa (if required)}
%   \label{fig:fast_path_plane_strains}
% \end{figure}
