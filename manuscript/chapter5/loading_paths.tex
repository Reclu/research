...
\begin{figure}[h!]
  ...
  \label{fig:fast_path_plane_strains}
\end{figure}
% \pgfplotstableread{chapter5/pgfFigures/pgf_fastWavesPlaneStress/CPfastStressPlane_frame3_Stress0.pgf}\loadedtable
% %\pgfplotstabletypeset[columns={sigma_11,sigma_12}]\loadedtable
