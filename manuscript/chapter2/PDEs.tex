...
\paragraph{The existence theorem of Cauchy and Kowalewsky}
...
\end{equation}
% where f_i are functions that depend analytically on its variables (i.e. they can be expanded into power series in all these variables converging in a suitably small domain, which may be assumed to contain the origin x_k=0)
...
\paragraph{The concept of characteristics}
\cite[p.55]{Courant}
