...
\end{equation}
A first order system of $I$ partial differential equations admits $I$ real eigenvalues associated to independent eigenvectors is called \textit{hyperbolic} \cite{Leveque,Toro}. For those problems one can draw a set of one-parameter families of curves in the $(x,t)$ plane by integrating the $I$ relations $\lambda^k=dx/dt$.
\begin{example}
  \label{ex:charac1}
