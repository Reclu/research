...
\end{equation}
Such a problem is called \textit{hyperbolic}. \textit{Hyperbolicity} can be formulated for first order systems as the requirement for a quasi-linear system of dimension $I$ to possess $I$ real eigenvalues associated to $I$ linearly independent eigenvectors. According to the definition \eqref{eq:lambda_slope}, it appears that a family of curves $\Cscr^k_0$ is a set of characteristic curves which slopes in the $(x,t)$ plane are $\lambda^k$.
