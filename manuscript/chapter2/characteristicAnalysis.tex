...
\begin{figure}[h]
  \centering
  \subfloat[Right-going shock wave\label{subfig:2S}]{\input{chapter2/pgfFigures/picard_2_shock}}
  \subfloat[Right-going simple wave\label{subfig:2R}]{\input{chapter2/pgfFigures/picard_2_rarefaction}}
...
\begin{figure}[h]
  \centering
  \subfloat[$F_L < F_R$\label{subfig:1S2R}]{\input{chapter2/pgfFigures/1S2R}}
  \subfloat[$F_L > F_R$\label{subfig:1R2S}]{\input{chapter2/pgfFigures/1R2S}}
...
\begin{figure}[h]
  \centering
  \subfloat[Initial data: $F_L=1 ; F_R=2$ \label{subfig:1S2R_curves}]{\input{chapter2/pgfFigures/1S2R_solution}}
  \subfloat[Initial data: $F_L=2 ; F_R=1$ \label{subfig:1S2R_curves}]{\input{chapter2/pgfFigures/1R2S_solution}}
...
\end{figure} \todo{parameters value !}


\begin{remark} \todo{rephrase this block}
