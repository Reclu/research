\begin{tikzpicture}[scale=0.75]
  ...
  \end{scope}
  \node at (7.,-.95) {$\Omega_t$};
  \draw[->,>=stealth] (-5,-2.5) -- (-1.,1.5) node [midway,above left] {$\X$};
  \draw[->,>=stealth] (-5,-2.5) -- (6.,-1.5) node [midway,above] {$\vect{\phi}(\vect{X},t)$};
  \draw[->,>=stealth] (-1.,1.5) -- (6.,-1.5) node [midway,above right] {$\vect{U}(\vect{X},t)$};
\end{tikzpicture}
