\begin{tikzpicture}[scale=0.8]
  ...
  \draw[very thick,->] (-5,-2.5) -- (-2.5,-2.5) node [right] {$\vect{E}_1,\vect{e}_1$};
  \draw[very thick,->] (-5,-2.5) -- (-5,0.) node [right] {$\vect{E}_3,\vect{e}_3$};
  \draw[very thick,->] (-5,-2.5) -- (-3.5,-1.5) node [right] {$\vect{E}_2,\vect{e}_2$};

  % \draw[very thick,->] (-5,-2.5) -- (-2.5,-2.5) node [right] {$X_1,x_1$};
  % \draw[very thick,->] (-5,-2.5) -- (-5,0.) node [right] {$X_3,x_3$};
  % \draw[very thick,->] (-5,-2.5) -- (-3.5,-1.5) node [right] {$X_2,x_2$};
  
  % \draw[very thick,->] (3,-3.5-1.) -- (4.,-4.25-1.) node [right] {$\vect{e}_1$};
  ...
  \end{scope}
  \node at (6.9,-1.) {$\Omega(t)$};
  \node at (-1.,1.5) {$\bullet$};
  \node[above] at (-1.,1.5) {$\X$};
  \node at (5.,-0.95) {$\bullet$};
  \node at (5.,-0.65) {$\vect{\phi}(\vect{X},t)$};
