...
\begin{subequations}
  \begin{alignat}{2}
    \label{eq:flow_rule}
    & \tens{\dot{\eps}}^p=\drond{\Phi}{\tens{\sigma}}\\%\drond{\Phi}{f}\drond{f}{\tens{\sigma}} \\ 
...
\begin{equation}
  ...
  \dot{f}=0
\end{equation}
\item \textbf{Viscoplasticity} or \textbf{rate-dependent} plasticity for which thermodynamic forces satisying $f(\tensor{\sigma},\Abc)>0$ are admissible and plastic evolution is completely determined by the knowlegde of the dissipation pseudo-potential.
\end{itemize}
