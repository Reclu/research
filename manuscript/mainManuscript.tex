\documentclass[10pt,a4paper,notitlepage,twoside,openright]{book}
...
\input{template-Spi-Manuscript/Preambule}
\usepackage{amsmath}
...
\input{template-Spi-Manuscript/Funct_TemplateECN}
\input{template-Spi-Manuscript/Input_TemplateECN}
\makeatother
\begin{document}
\tableofcontents{}
