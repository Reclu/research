...
FEM has become attractive due to its ability to handle low or high-order approximation, and to easily deal with complex geometries and nonlinear constitutive models as these mentioned above.  %% At integration points
