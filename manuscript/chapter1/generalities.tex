...
Indeed, the combination of large deformations with a wave structure can lead to complex loading paths that are not even observed at the model level. %apprehended at the model level.
