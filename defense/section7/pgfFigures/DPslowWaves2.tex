...
axis on top,scale only axis,width=0.4\linewidth,ymin=0,ymax=175117802.1582484
...
\addplot[mesh,point meta = \thisrow{p},very thick,no markers] table[x=sigma_11,y=sigma_12] {chapter5/pgfFigures/pgf_slowWavesPlaneStrain/DPslowStressPlane_frame4_Stress2.pgf} node[above,black] {$\textbf{5}$};
...
\addplot[mesh,point meta = \thisrow{p},very thick,no markers] table[x=sigma_22,y=sigma_12] {chapter5/pgfFigures/pgf_slowWavesPlaneStrain/DPslowStressPlane_frame4_Stress2.pgf} node[above,black] {$\textbf{5}$};
\end{groupplot}
\end{tikzpicture}
%%% Local Variables:
%%% mode: latex
