...
\begin{frame}{One-dimensional elastic-plastic medium}
  ...
  \end{block}
  \vspace{-0.2cm}
  \footnoteCite{Wang,Fogarty,Thomas_EP}
\end{frame}

\begin{frame}{One-dimensional elastic-plastic medium \cite{Thomas_EP}}
  \centering
  \movie[height = 0.75\paperheight,width=.625\linewidth, showcontrols,poster,loop,autostart]{%\input{section4/pgfFigures/PS_taylorbar}
