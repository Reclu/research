\begin{tikzpicture}[scale=0.7]
  \begin{axis}[ymajorgrids=true,xmajorgrids=true,ylabel=$\tau \: (Pa)$,xlabel=$\sigma \: (Pa)$,xmin=-0.1e8,xmax=1.5e8,ymin=0.,ymax=7.5e7, legend pos=north east]
    ...
    \addplot[very thick,Red,restrict x to domain=0.25e8:0.5e8,arrows along my path] table [x=sigma_11,y=sigma_12]{section5/pgfFigures/pgf_thinWalledTubeSlowWave/TWslow_yield0.pgf};
    ...
    \addplot[very thick,Red,arrows along my path] coordinates{ (0.28e8,5.55e7)  (0.28e8,0.) (0,0)};
