...
%% OR with baptiste's clock
\defbeamertemplate*{footline}{mytheme2}{%
  \usebeamerfont{page number in head/foot}\begin{beamercolorbox}[sep=1.em]{} \hfill \insertframenumber{} \myBeamerClock{1ex}{-0.75ex}
 \end{beamercolorbox}
}
  ...
  \begin{scriptsize}
    ...
    \begin{overprint}
      ...
      \vskip -6pt
        ...
        \item Classical constitutive integrators at material points
        \end{itemize}
      \end{block}
      \footnoteCite{DGMPM_stab}
    \end{overprint}
...
%   \setbeamercolor{alerted text}{fg=CNBlue}
%   \setbeamercolor{normal text}{ fg= CNBlue , bg= white }
...
\begin{frame}[standout]{\text{Future works}}
  ...
  \begin{footnotesize}
    ...
    \begin{block}{\text{Elastic-plastic approximate Riemann solver in 2D}}
      \begin{itemize}
