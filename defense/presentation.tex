  ...
  \begin{frame}[standout]{\text{Conclusion of part I}}
    ...
    \begin{scriptsize}
      \begin{block}{\footnotesize \text{Development of the DGMPM in total Lagrangian}}
        ...
        \item Riemann problems at cells faces $\rightarrow$ take into account the characteristic structure
          % \begin{itemize}
        ...
        \item Ability to compute the optimal Courant number (1D and 2D)
        \item Non-oscillating solutions %-- reduced diffusion compared to original MPM-PIC
...
\begin{frame}[standout]{\text{General conclusion}}
  ...
  \begin{block}{\text{Objective 2: \footnotesize Identify the response of two-dimensional elastic-plastic solids to dynamic loadings}}
    ...
    \item[] Some \underline{typical responses} for plane strain and plane stress problems can be highlighted
    \end{itemize}
  \end{block}\pause
