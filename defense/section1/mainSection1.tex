    ...
    \begin{column}{0.3\textwidth}
      \begin{block}{Finite Element Method}
        \begin{tikzpicture}[scale=0.5]
          ...
          \tkzKiviatLine[thick,color = Blue,fill= Blue,opacity=.7](4,4,1,1,4)
        \end{tikzpicture}
      \end{block}
    \end{column}
    \begin{column}{0.3\textwidth}
    ...
    \begin{column}{0.33\textwidth}
      \begin{block}{Discontinuous Galerkin FEM}
        \begin{tikzpicture}[scale=0.5]
          ...
          \tkzKiviatLine[thick,color = Blue!70](4,4,1,1,4)
...
\begin{frame}{Mesh-free Lagrangian approaches: The Material Point Method}
  ...
  \begin{columns}
    \begin{column}{0.4\textwidth}
      \begin{block}{FLuid Implicit Particle mapping}
        \begin{tikzpicture}[scale=0.5]
          \tkzKiviatDiagram[lattice=4,
          label style/.append style={font=\scriptsize},radial  style/.style ={->},lattice style/.style ={white,opacity=0}]{CFL,Non-diffusive,Entanglement,Non-oscillating,High-order}
          \tkzKiviatLine[thick,color = black!50](4,4,4,4,4)
    ...
    \end{column}
    \begin{column}{0.4\textwidth}
      \begin{block}{Particle-in-cell mapping}
       \begin{tikzpicture}[scale=0.5]
          \tkzKiviatDiagram[lattice=4,
          label style/.append style={font=\scriptsize},radial  style/.style ={->},lattice style/.style ={white,opacity=0}]{CFL,Non-diffusive,Entanglement,Non-oscillating,High-order}
          \tkzKiviatLine[thick,color = black!50](4,4,4,4,4)
