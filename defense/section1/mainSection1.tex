          ...
          \begin{column}{0.48\textwidth}
            \begin{block}{\footnotesize Lagrangian formulation}
              ...
              \begin{tikzpicture}[scale=0.4]
                ...
                label style/.append style={font=\tiny},radial  style/.style ={->},lattice style/.style ={white,opacity=0},label space=1.5]{Non-diffusive,Mesh robustness,Non-oscillating,High-order}
      ...
      \begin{columns}
        \begin{column}{0.6\textwidth}
          \begin{tikzpicture}[scale=0.5]
            ...
            \tkzKiviatLine[thick,color = Green,fill= Green,opacity=.7](2,4,4,2)
          \end{tikzpicture}
        \end{column}
        \begin{column}{0.4\textwidth}
          \textbf{Ingredients:}
