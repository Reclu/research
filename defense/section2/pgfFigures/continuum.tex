\begin{tikzpicture}[scale=0.35]
  ...
  \begin{scope}[shift={(9,0)}]
    % \draw[step=1.0,black,thin] (-3.,-1.) grid (3,4.);
    % % contour
    % \node at (0,0.9) {\tiny$\bullet$}  ;
    % \node at (2.5,1.65) {\tiny$\bullet$}  ; 
    % \node at (0,2.6) {\tiny$\bullet$}  ;
    % \node at (-2.25,1.1) {\tiny$\bullet$}  ; 
    % \node at (-1.5,0.35) {\tiny$\bullet$}  ; 
    % \node at (-2.,0.45) {\tiny$\bullet$} ;
    % \node at (-2.2,1.5) {\tiny$\bullet$}  ; 
    % \node at (-1.5,2.3) {\tiny$\bullet$} ; 
    % \node at (2.35,1.) {\tiny$\bullet$}  ;
    % \node at (2.25,2.15) {\tiny$\bullet$}  ;
    % \node at (0.55,0.8) {\tiny$\bullet$}  ; 
    % \node at (-0.5,2.6) {\tiny$\bullet$};
    % \node at (0.5,2.59) {\tiny$\bullet$}  ;
    % \node at (1.5,2.45) {\tiny$\bullet$}  ;
    % \node at (1,0.75) {\tiny$\bullet$}; 
    % \node at (2,0.75) {\tiny$\bullet$}  ;
    % \node at (2,2.3) {\tiny$\bullet$}  ;
    % \node at (1,2.55) {\tiny$\bullet$}  ;
    % \node at (-1,2.5) {\tiny$\bullet$}  ; 
    % \node at (-1.95,2.) {\tiny$\bullet$}  ;
    % % interior
    % \node at (-1.5,1.5) {\tiny$\bullet$}  ; 
    % \node at (-1.25,2.) {\tiny$\bullet$}  ;
    % \node at (-0.75,0.75) {\tiny$\bullet$}  ; 
    % \node at (-1.55,1.){\tiny$\bullet$} ;
    % \node at (-0.5,1.5) {\tiny$\bullet$}  ; 
    % \node at (-0.5,2.) {\tiny$\bullet$}  ;
    % \node at (0.25,1.45) {\tiny$\bullet$}  ;
    % \node at (0.35,2.) {\tiny$\bullet$}  ;
    % \node at (0.95,1.75) {\tiny$\bullet$}  ;
    % \node at (1.15,1.2) {\tiny$\bullet$} ;
    % \node at (1.45,2.15) {\tiny$\bullet$}  ; 
    % \node at (1.55,1.65) {\tiny$\bullet$}  ;
    % \node at (1.85,1.15) {\tiny$\bullet$}  ; 
    % \node at (2.15,1.75) {\tiny$\bullet$}  ;
    % \node at (-1.,1.25) {\tiny$\bullet$}  ;
    % \draw(3,0.5) -- (3.4,0.5) node [right]  {$\Omega_g$};
    % \draw[line width=0.4mm,Red] (-2.5,4.25) -- (-2.,4.25) node [right] {\text{boundary of the domain}};
  ...
  \draw[line width=0.4mm,Red] (-3,4.25) -- (-2.5,4.25) node [right] {\scriptsize \text{Mesh boundary}};
