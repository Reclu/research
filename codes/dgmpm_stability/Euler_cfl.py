...
print "**************************************************************"
solution=optimize.root(symbolResidual(0,shape_functions(0.5*np.array([1.-1./np.sqrt(3.),1.+1./np.sqrt(3.)])),shape_functions(np.array([0.25,0.75]))),1.,method='hybr',options={'xtol':1.e-4}).x
print "Solution is: ",solution
############### 3PPC
print "**************************************************************"
