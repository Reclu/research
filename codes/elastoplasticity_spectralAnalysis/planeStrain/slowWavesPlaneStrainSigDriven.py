...
#for k in range(len(sig22)):
    ...
    for s,i in enumerate(frames):
        ...
        for j in range(Niter-1):
            TAU[j+1,s,k],SIG22[j+1,s,k],SIG33[j+1,s,k],epsp33=integrateODE(dsig,SIG11[j,s,k],TAU[j,s,k],SIG22[j,s,k],SIG33[j,s,k],epsp33,nu,E,H,lamb,mu,beta,tangent)
            sig0=SIG11[j+1,s,k];
        ...
        if Nfinal/100>5:
            ...
            pas=2
        export2pgfPlotFile(fileName,np.array([TAU[0:Nfinal:pas,s,k],SIG11[0:Nfinal:pas,s,k],SIG22[0:Nfinal:pas,s,k],rcs2[0:Nfinal:pas,s,k],LodeAngle_S[0:Nfinal:pas,s,k],eigsigS[0:Nfinal:pas,s,k,2]+eigsigS[0:Nfinal:pas,s,k,1]+eigsigS[0:Nfinal:pas,s,k,0],eigsigDevS[0:Nfinal:pas,s,k,2],MaxCrit[0:Nfinal:pas,s,k]]),'sigma_12','sigma_11','sigma_22','p','Theta','hydro','s3','maxCrit')
        ...
        # export2DTeXFile('LodeAngle_s22.tex',np.array([LodeAngle_S[0:Nfinal:pas,0,k],LodeAngle_S[0:Nfinal:pas,1,k],LodeAngle_S[0:Nfinal:pas,2,k],LodeAngle_S[0:Nfinal:pas,3,k]]),r'$\Theta ()$',r'$\sigma_{11} \: (Pa)$','',np.array([SIG22[0:Nfinal:pas,0,k],SIG22[0:Nfinal:pas,1,k],SIG22[0:Nfinal:pas,2,k],SIG22[0:Nfinal:pas,3,k]]),legend)
