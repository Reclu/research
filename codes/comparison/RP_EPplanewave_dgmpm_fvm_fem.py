...
for i,n1 in enumerate(frames):
    ...
    ax1.plot(MPM["pos"][:,2*n1],MPM["sig"][:,2*n1],'y',lw=2.,ms=4.,label='MPM')
    ax1.plot(DGMPM["pos"][:,n1],DGMPM["sig"][:,n1],'r',lw=2.,ms=4.,label='DGMPM')
    ...
    ax2.plot(MPM["pos"][:,2*n1],MPM["epsp"][:,2*n1],'y',lw=2.,ms=4.,label='MPM')
    ax2.plot(DGMPM["pos"][:,n1],DGMPM["epsp"][:,n1],'r',lw=2.,ms=4.,label='DGMPM')
