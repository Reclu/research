...
\nextgroupplot[title={(a) Evolution with respect to $\sigma_{12}$},xlabel=$\sigma_{12}  (Pa)$]
...
\nextgroupplot[title={(b) Evolution with respect to $\sigma_{22}$},xlabel=$\sigma_{22}  (Pa)$,
