...
\begin{tikzpicture}%[scale=0.9]
  \begin{axis}[width=.75\textwidth,view={135}{35.2643},xlabel=$s_1 $,
    ...
    %%
    \addplot3[Blue,mark=x,only marks,mark repeat=31,very thick,mark size=3pt] file {pgfFigures/pgf_thinWalledTubeFastWave/fastDevPlane_Stress.pgf};
    \addplot3[Red,arrows along my path,thick] file {pgfFigures/pgf_thinWalledTubeFastWave/fastDevPlane_Stress.pgf};
    %% Yield surface
    \addplot3[black,dashed,very thick] file {pgfFigures/pgf_thinWalledTubeSlowWave/TWCylindreDevPlane.pgf};
